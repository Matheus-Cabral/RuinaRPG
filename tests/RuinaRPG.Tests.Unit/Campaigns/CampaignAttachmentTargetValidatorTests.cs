...
public class CampaignAttachmentTargetValidatorTests
{
    ...
    {
        CampaignAttachmentTargetValidator.ExactlyOneSet("item-1", null, null, null, null, null).Should().BeTrue();
        CampaignAttachmentTargetValidator.ExactlyOneSet(null, null, null, null, "image-1", null).Should().BeTrue();
    }
    ...
    {
        CampaignAttachmentTargetValidator.ExactlyOneSet("item-1", "npc-1", null, null, null, null).Should().BeFalse();
    }
