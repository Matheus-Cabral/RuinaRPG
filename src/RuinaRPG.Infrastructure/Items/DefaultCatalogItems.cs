...
public static class DefaultCatalogItems
{
    public static List<Item> Build(Guid gmId)
    {
        var items = new List<Item>
        {
            ...
            new Arma { Nome = "Varinha de Carvalho", Subcategoria = "Varinhas Mágicas", Tier = Tier.F, Empunhadura = Empunhadura.UmaMao, Dados = "2D4", Dano = 2, Critico = "2x", Alcance = 6, TipoDeDano = TipoDeDano.Magico, RequisitoAtributo = null, Descricao = null },
            new Arma { Nome = "Varinha Reforçada de Carvalho", Subcategoria = "Varinhas Mágicas", Tier = Tier.E, Empunhadura = Empunhadura.UmaMao, Dados = "2D6", Dano = 4, Critico = "19", Alcance = 6, TipoDeDano = TipoDeDano.Magico, RequisitoAtributo = null, Descricao = null },
            new Arma { Nome = "Varinha de Juazeiro", Subcategoria = "Varinhas Mágicas", Tier = Tier.D, Empunhadura = Empunhadura.UmaMao, Dados = "2D8", Dano = 4, Critico = "2x", Alcance = 6, TipoDeDano = TipoDeDano.Magico, RequisitoAtributo = null, Descricao = null },
            new Arma { Nome = "Varinha Retorcida de Juazeiro", Subcategoria = "Varinhas Mágicas", Tier = Tier.C, Empunhadura = Empunhadura.UmaMao, Dados = "2D10", Dano = 5, Critico = "19", Alcance = 7, TipoDeDano = TipoDeDano.Magico, RequisitoAtributo = null, Descricao = null },
            new Arma { Nome = "Varinha de Teixo", Subcategoria = "Varinhas Mágicas", Tier = Tier.B, Empunhadura = Empunhadura.UmaMao, Dados = "3D12", Dano = 6, Critico = "3x", Alcance = 8, TipoDeDano = TipoDeDano.Magico, RequisitoAtributo = null, Descricao = null },
            new Arma { Nome = "Cajado de Carvalho", Subcategoria = "Cajados Mágicos", Tier = Tier.E, Empunhadura = Empunhadura.DuasMaos, Dados = "2D6", Dano = 2, Critico = "2x", Alcance = 10, TipoDeDano = TipoDeDano.Magico, RequisitoAtributo = null, Descricao = null },
            new Arma { Nome = "Cajado Reforçado de Carvalho", Subcategoria = "Cajados Mágicos", Tier = Tier.D, Empunhadura = Empunhadura.DuasMaos, Dados = "2D8", Dano = 3, Critico = "19", Alcance = 10, TipoDeDano = TipoDeDano.Magico, RequisitoAtributo = null, Descricao = null },
            new Arma { Nome = "Cajado Retorcido de Juazeiro", Subcategoria = "Cajados Mágicos", Tier = Tier.C, Empunhadura = Empunhadura.DuasMaos, Dados = "2D10", Dano = 6, Critico = "2x", Alcance = 12, TipoDeDano = TipoDeDano.Magico, RequisitoAtributo = null, Descricao = null },
            new Arma { Nome = "Cajado de Teixo", Subcategoria = "Cajados Mágicos", Tier = Tier.B, Empunhadura = Empunhadura.DuasMaos, Dados = "3D12", Dano = 4, Critico = "18", Alcance = 15, TipoDeDano = TipoDeDano.Magico, RequisitoAtributo = null, Descricao = null },
