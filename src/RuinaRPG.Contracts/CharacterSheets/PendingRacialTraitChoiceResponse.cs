...
/// </summary>
public record PendingRacialTraitChoiceResponse(bool Pending, List<RacialTraitChoiceOptionResponse> Gratuita, List<RacialTraitChoiceOptionResponse> Obrigatoria);
